...
export default function AdsPrevArrow(props: CustomArrowProps) {
  ...
  return (
    ...
    >
      ...
      >
        <g id="Left_arrow" transform="translate(3511.241 2978.741)">
          <g
            id="right-arrow"
            transform="translate(-3469.069 -2929.946) rotate(180)"
          >
